  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="index.php"><i class="fa fa-user"></i> Beranda Post</a></li>
            ...
            <div class="box-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo $row['author'] ?>" id="author" placeholder="Masukan Nama" name="author">
                </div>
                <div class="form-group">
                  <label for="title">Title</label>
                  <input type="text" class="form-control" value="<?php echo $row['title']?>" id="title" placeholder="Masukan title" name="title">
                </div>

                <div class="form-group">
                  <label for="content">content</label><br>
                  <textarea rows="5" cols="30" name="content" value="<?php echo $row['content']?>"></textarea>
                </div>

                <div class="form-group">
                  <label for="status">Status</label>
                  <input type="checkbox" value="1" name="status">Publish
                  <input type="checkbox" value="0" name="status">Draft
                </div>
               <!--  <div class="form-group">
